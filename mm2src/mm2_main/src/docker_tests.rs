...
mod docker_tests {
    ...
    use coins::{CoinProtocol, FoundSwapTxSpend, IguanaPrivKey, MarketCoinOps, MmCoin, PrivKeyBuildPolicy,
                SearchForSwapTxSpendInput, SwapOps, Transaction, TransactionEnum, WatcherOps, WithdrawRequest};
    ...
    impl BchDockerOps {
        ...
        fn initialize_slp(&self) {
            ...
            for _ in 0..18 {
                ...
                slp_privkeys.push(key_pair.private().secret.take());
            }
    ...
    fn test_maker_order_should_not_kick_start_and_appear_in_orderbook_if_balance_is_withdrawn() {
        ...
        let order_path = mm_bob.folder.join(format!(
            "DB/{}/ORDERS/MY/MAKER/{}.json",
            hex::encode(rmd160_from_priv(bob_priv_key)),
            uuid
        ));
