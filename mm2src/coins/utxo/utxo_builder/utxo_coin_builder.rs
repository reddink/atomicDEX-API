...
use crate::{BlockchainNetwork, CoinTransportMetrics, DerivationMethod, HistorySyncState, PrivKeyBuildPolicy,
            PrivKeyPolicy, PrivKeyPolicyNotAllowed, RpcClientType, UtxoActivationParams};
...
#[async_trait]
pub trait UtxoCoinBuilder: UtxoFieldsWithSecp256k1SecretBuilder + UtxoFieldsWithHardwareWalletBuilder {
    type ResultCoin;
...
#[async_trait]
pub trait UtxoFieldsWithSecp256k1SecretBuilder: UtxoCoinBuilderCommonOps {
    async fn build_utxo_fields_with_secp256k1_secret(
        &self,
