...
impl SwapOps for QtumCoin {
    ...
    fn send_maker_spends_taker_payment(
        ...
        utxo_common::send_maker_spends_taker_payment(self.clone(), taker_tx, time_lock, taker_pub, secret, htlc_privkey)
    }
...
#[async_trait]
impl ListAddressRpcOps for QtumCoin {
...
#[async_trait]
impl EnableAddressRpcOps for QtumCoin {
